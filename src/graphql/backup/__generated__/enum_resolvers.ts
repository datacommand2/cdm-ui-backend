import {
  BackupBackupClusterTypeEnumResolvers,
  BackupBackupJobStateCodeEnumResolvers,
  BackupBackupJobTypeEnumResolvers,
  BackupBackupTypeEnumResolvers,
  ...
  OpenStackDrKeypairTypeEnumResolvers,
  OpenStackDrNetworkTypeEnumResolvers,
  OpenStackDrSecurityGroupRuleDirectionEnumResolvers,
  OpenStackDrSecurityGroupRuleEtherTypeEnumResolvers,
  OpenStackDrStorageTypeEnumResolvers,
  OpenStackDrSubnetIpv6AddressModeCodeEnumResolvers,
  OpenStackDrSubnetIpv6RaModeCodeEnumResolvers,
...
export const BackupBackupClusterTypeEnum = <BackupBackupClusterTypeEnumResolvers>{
  CLUSTER_TYPE_OPENSTACK: 'cluster.type.openstack',
  CLUSTER_TYPE_OPENSHIFT: 'cluster.type.openshift',
};

export const BackupBackupJobStateCodeEnum = <BackupBackupJobStateCodeEnumResolvers>{
  CDM_BACKUP_JOB_STATE_PREPARING: 'cdm.backup.job-state.preparing',
  CDM_BACKUP_JOB_STATE_WAITING: 'cdm.backup.job-state.waiting',
  CDM_BACKUP_JOB_STATE_PENDING: 'cdm.backup.job-state.pending',
  CDM_BACKUP_JOB_STATE_RUNNING: 'cdm.backup.job-state.running',
  CDM_BACKUP_JOB_STATE_DONE: 'cdm.backup.job-state.done',
  CDM_BACKUP_JOB_STATE_FAILED: 'cdm.backup.job-state.failed',
};

export const BackupBackupJobTypeEnum = <BackupBackupJobTypeEnumResolvers>{
  CDM_BACKUP_JOB_TYPE_SCHEDULED: 'cdm.backup.job-type.scheduled',
  CDM_BACKUP_JOB_TYPE_IMMEDIATE: 'cdm.backup.job-type.immediate',
  CDM_BACKUP_JOB_TYPE_RESERVED: 'cdm.backup.job-type.reserved',
};

export const BackupBackupTypeEnum = <BackupBackupTypeEnumResolvers>{
  CDM_BACKUP_BACKUP_TYPE_FULL_BACKUP: 'cdm.backup.backup-type.full-backup',
  CDM_BACKUP_BACKUP_TYPE_INCREMENTAL_BACKUP: 'cdm.backup.backup-type.incremental-backup',
  CDM_BACKUP_BACKUP_TYPE_DIFFERENTIAL_BACKUP: 'cdm.backup.backup-type.differential-backup',
};
...
export const OpenStackDrKeypairTypeEnum = <OpenStackDrKeypairTypeEnumResolvers>{
  OPENSTACK_KEYPAIR_TYPE_SSH: 'openstack.keypair.type.ssh',
  OPENSTACK_KEYPAIR_TYPE_X509: 'openstack.keypair.type.x509',
};

export const OpenStackDrNetworkTypeEnum = <OpenStackDrNetworkTypeEnumResolvers>{
  OPENSTACK_NETWORK_TYPE_VLAN: 'openstack.network.type.vlan',
  OPENSTACK_NETWORK_TYPE_VXLAN: 'openstack.network.type.vxlan',
  OPENSTACK_NETWORK_TYPE_GRE: 'openstack.network.type.gre',
  OPENSTACK_NETWORK_TYPE_FLAT: 'openstack.network.type.flat',
  OPENSTACK_NETWORK_TYPE_LOCAL: 'openstack.network.type.local',
};

export const OpenStackDrSecurityGroupRuleDirectionEnum = <OpenStackDrSecurityGroupRuleDirectionEnumResolvers>{
  INGRESS: 'ingress',
  EGRESS: 'egress',
};

export const OpenStackDrSecurityGroupRuleEtherTypeEnum = <OpenStackDrSecurityGroupRuleEtherTypeEnumResolvers>{
  FOUR: '4',
  SIX: '6',
};

export const OpenStackDrStorageTypeEnum = <OpenStackDrStorageTypeEnumResolvers>{
  OPENSTACK_STORAGE_TYPE_LVM: 'openstack.storage.type.lvm',
  OPENSTACK_STORAGE_TYPE_NFS: 'openstack.storage.type.nfs',
};

export const OpenStackDrSubnetIpv6AddressModeCodeEnum = <OpenStackDrSubnetIpv6AddressModeCodeEnumResolvers>{
  SLAAC: 'slaac',
  DHCPV6_STATEFUL: 'dhcpv6-stateful',
  DHCPV6_STATELESS: 'dhcpv6-stateless',
};

export const OpenStackDrSubnetIpv6RaModeCodeEnum = <OpenStackDrSubnetIpv6RaModeCodeEnumResolvers>{
  SLAAC: 'slaac',
  DHCPV6_STATEFUL: 'dhcpv6-stateful',
  DHCPV6_STATELESS: 'dhcpv6-stateless',
};
